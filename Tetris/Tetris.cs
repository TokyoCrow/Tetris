namespace Tetris.Core
{
    ...
    public class Tetris
    {
        ...
        public Tetris(TetrisModel model)
        {
            GameField = model.GameField;
            Score = model.Score;
            FallingTetrominoX = model.FallingTetrominoX;
            FallingTetrominoY = model.FallingTetrominoY;
            FallingTetromino = Tetramino.SetTetramino(model.FallingTetromino);
            NextTetromino = Tetramino.SetTetramino(model.NextTetromino);
